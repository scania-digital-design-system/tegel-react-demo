    ...
    return (
        <>
            <article className={`form ${sendingStatus ? 'form-sending' : ''}`}>
                ...
                >
                    <h3 className="tds-u-mb2 tds-u-mt1">Form example</h3>
                    <p className="tds-headline-05 tds-text-grey-800">
                        This is a form built using @scania/tegel and it purpose it to validate that the input
                        element in @scania/tegel work within a form.
                    </p>
                    ...
                    <section>
                        <tds-button type="submit" size="sm" fullbleed text={!sendingStatus ? 'Submit' : ''}>
                            {sendingStatus && (
                                <span slot="label">
