  ...
  return (
    <TdsBlock key={`tab-panel-${selectedTabIndex}`}>
      ...
      <p>
        ...
        voluptatum dicta nisi laudantium sunt eum, velit porro quas dignissimos obcaecati. Veritatis
        exercitationem possimus quos animi atque maxime fuga, voluptatum nostrum ab ea voluptate
